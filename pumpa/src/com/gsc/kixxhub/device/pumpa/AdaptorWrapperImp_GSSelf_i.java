...
public class AdaptorWrapperImp_GSSelf_i implements AdaptorListener {
	...
	public static void main(String[] args) {
		...
		AdaptorListener listener = new AdaptorWrapperImp_GSSelf_i();
