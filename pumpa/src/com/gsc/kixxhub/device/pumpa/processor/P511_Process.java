...
public class P511_Process implements Processor {

	private String messageID = null;
	private String nextCommand 	= IPumpConstant.COMMANDID_BR;
	...
	public void startProcess(WorkingMessage workMsg) throws Exception {
		...
		if (command.equals(IPumpConstant.COMMANDID_BR)) {
			
			this.sendDeviceMsg(workMsg);
		
		} else {
			LogUtility.getLogger().debug("### Incorrect workingMessage in Process 511 ###");
