...
public class AdaptorWrapperImp_TsnMPPL implements AdaptorListener {
	...
	public static void main(String[] args) {
		...
		AdaptorListener listener = new AdaptorWrapperImp_TsnMPPL();
		...
		String groupODTNo="61";	// 다쓰노 셀프ODT	
		//======== DBox Port 정의 ========//
		...
		nozInfo.setNozProtocol(Change.toString("%02d", Protocol.TatsunoMPP6)); 
		nozInfo.setBaudRate("19200");
		nozInfo.setRomVersion("151");
		nozInfo.setSelfOdtNo(groupODTNo); // 연결ODT
		nozList.add(nozInfo);
		...
		nozInfo.setNozzleNo(groupODTNo);
		nozInfo.setNozzleType("05"); // 셀프ODT
		nozInfo.setNozProtocol(Change.toString("%02d", Protocol.TatsunoMPPL_vODT)); 
		nozInfo.setBaudRate("19200");
		...
		*/
		...
		P5_odtWm22.setOdtID(groupODTNo);
...
//		PA_wm.setNozzleNo("13"); // Self nozzle
...
//		PA_wm2.setNozzleNo("13"); // Self nozzle
...
//		// 정액/정량 설정 (셀프: 선결제지시)
//		Sleep.sleep(20000);
//		PB_WorkingMessage PB_wm2 = new PB_WorkingMessage();
//		PB_wm2.setNozzleNo("13"); // Self nozzle
//		PB_wm2.setConnectNozzleNo("00"); // Self nozzle
//		PB_wm2.setCommandSet("0"); // 0=정액설정, 1=정량설정
//		PB_wm2.setLiter("0000000");
//		PB_wm2.setBasePrice("178800");
//		PB_wm2.setPrice("00020000");
//		adaptor.sendModuleMsg(PB_wm2);
