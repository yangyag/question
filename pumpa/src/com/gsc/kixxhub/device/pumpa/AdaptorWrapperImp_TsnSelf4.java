...
public class AdaptorWrapperImp_TsnSelf4 implements AdaptorListener {
	...
	public static void main(String[] args) {
		...
		AdaptorListener listener = new AdaptorWrapperImp_TsnSelf4();
...
/*
		...
		PA_wm.setNozzleNo("12"); // Self nozzle
