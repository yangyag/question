...
public class AdaptorWrapperImp_SomoSelfN2 implements AdaptorListener {
	...
	public static void main(String[] args) {
		...
		AdaptorListener listener = new AdaptorWrapperImp_SomoSelfN2();
