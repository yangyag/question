...
public class AdaptorWrapperImp_TsnSelf6B implements AdaptorListener {
	...
	public static void main(String[] args) {
		...
		AdaptorListener listener = new AdaptorWrapperImp_TsnSelf6B();
		...
		nozInfo.setNozzleNo("22");
		nozInfo.setNozzleType("05"); // 셀프ODT
		nozInfo.setNozProtocol(Change.toString("%02d", Protocol.TatsunoSelfMPP6)); 
		nozInfo.setBaudRate("19200");
		nozInfo.setRomVersion("351"); // BNA용
		...
		nozInfo.setNozProtocol(Change.toString("%02d", Protocol.TatsunoSelfMPP6)); 
		nozInfo.setBaudRate("19200");
		nozInfo.setRomVersion("361"); // BNA용
		nozInfo.setSelfOdtNo("00"); // 연결 주유기
		nozList.add(nozInfo);
		...
		P5_nozWm22_1.setNozzleNumber("31");
		...
		P5_nozWm22_2.setNozzleNumber("32");
		...
		P5_nozWm22_3.setNozzleNumber("33");
