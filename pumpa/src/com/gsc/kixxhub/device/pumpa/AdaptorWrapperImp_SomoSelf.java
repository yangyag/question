...
public class AdaptorWrapperImp_SomoSelf implements AdaptorListener {
	...
	public static void main(String[] args) {
		...
		AdaptorListener listener = new AdaptorWrapperImp_SomoSelf();
		...
		nozInfo.setNozzleNo("23");
		nozInfo.setNozzleType("05"); // 셀프ODT
		nozInfo.setNozProtocol(Change.toString("%02d", Protocol.SomoSelfN)); 
		...
		P5_odtWm.setOdtID("23");
		P5_odtWm.setNozzleCount("3");
		...
		P5_nozWm3.setNozzleNumber("17");
		P5_nozWm3.setBasePrice("195500"); // 4.2
...
*/
		...
		PB_wm.setNozzleNo("16"); // Self nozzle
		PB_wm.setConnectNozzleNo("23"); // Self nozzle
		PB_wm.setCommandSet("0"); // 0=정액설정, 1=정량설정
		PB_wm.setLiter("0000000");
		PB_wm.setBasePrice("157700");
		PB_wm.setPrice("00900000");
