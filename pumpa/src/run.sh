...
#PROPERTIESPATH=/opt/xpd_runtime_full
$JAVA_HOME/jre/bin/java -classpath $CLASSPATH -Dload.properties.from=$PROPERTIESPATH com.gsc.kixxhub.adaptor.pump.AdaptorWrapperImp
